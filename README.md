# Сопроводительная документация к решению задачи ЛЦТ № 12 Сервис планирования передачи данных от космических аппаратов на земные станции от команды solvers
